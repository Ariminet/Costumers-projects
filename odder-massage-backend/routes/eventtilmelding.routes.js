...
// ----- HENT/GET ALLE ------------------------------------------------------------------------------------------
// ----- GET http://localhost:5021/eventtilmelding
...
// ----- GET http://localhost:5021/eventtilmelding/xxxxx
...
// ----- OPRET/POST NY ----------------------------------------------------------------------------------------
// ----- POST http://localhost:5021/eventtilmelding/
// ----- Kræver ikke admin - brugerne skal kunne poste en eventtilmelding!

router.post('/', async (req, res) => {
    
    console.log("POST eventtilmelding", req.body);
...
// ----- SLET/DELETE ------------------------------------------------------------------------------------------------------------- 
// ----- DELETE http://localhost:5021/eventtilmelding/admin/xxxxxxxxx
...
// ----- RET/PUT ------------------------------------------------------------------------------------------------------------- 
// ----- PUT http://localhost:5021/eventtilmelding/admin/xxxxxxxxx
