...
app.use(session({
    ...
    store: new MongoStore({ mongooseConnection: db }), // EKSTRA HVIS session skal gemmes i mongo
    ...
    cookie: {                       // sat til http only fordi andet ikke er angivet
        ...
        // VIGTIGT: Når maxage er nået - fx om 2 minutter - så bliver det automatisk til en sessioncookie som slettes når browservindue (tab?) lukkes
        sameSite: 'none',             // 'strict' el true ... https://adzerk.com/blog/chrome-samesite/#:~:text=The%20SameSite%20attribute%20tells%20browsers,a%20cookie%20to%20be%20accessed.
...
// HEROKU - for at få set-cookie med ... https://github.com/expressjs/session/issues/600 ....  sethgoodluck commented on 10 Nov 2019
...
app.use('*/admin*', async (req, res, next) => {
    ...
    // Overvej denne https://teamtreehouse.com/library/writing-more-middleware - evt som middleware
